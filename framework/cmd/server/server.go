...
import (
	...
	"github.com.br/JoaoVictorPereiraTeixeira/application/services"
...
func init() {
	...
	if err != nil {
		log.Fatalf("Error parsin boolean env var - AUTO_MIGRATE_DB")
	}

	debug, err := strconv.ParseBool(os.Getenv("DEBUG"))

	if err != nil {
		log.Fatalf("Error parsin boolean env var - DEBUG")
	}
